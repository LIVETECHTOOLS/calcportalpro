...
export const metadata: Metadata = {
  title: 'Mortgage Calculator - Calculate Monthly Payments | CalcPortal Pro',
  description: 'Free mortgage calculator to estimate your monthly payments, interest costs, and loan amortization. Calculate mortgage payments with our easy-to-use tool.',
  keywords: 'mortgage calculator, home loan calculator, mortgage payment calculator, loan calculator, home financing calculator',
  openGraph: {
    title: 'Mortgage Calculator - Calculate Monthly Payments | CalcPortal Pro',
    description: 'Free mortgage calculator to estimate your monthly payments, interest costs, and loan amortization.',
