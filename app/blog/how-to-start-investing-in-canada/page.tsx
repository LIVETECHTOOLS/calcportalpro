...
export const metadata: Metadata = {
  title: "how to start investing in canada - what is mer in investing | CalcPortal Pro",
  description:
      ...
      <div className="prose prose-lg max-w-3xl bg-white p-6 rounded-2xl shadow-lg">
        ...
        <table className="table-auto w-full border-collapse border border-gray-300 my-6">
          <thead>
            <tr className="bg-gray-100">
              <th className="border border-gray-300 px-4 py-2">Fund Type</th>
              <th className="border border-gray-300 px-4 py-2">Typical MER</th>
              <th className="border border-gray-300 px-4 py-2">Impact Over 20 Years</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td className="border px-4 py-2">Huge (can reduce final portfolio by 30%+)</td>
            </tr>
          </tbody>
        </table>
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
            <strong>Q: how to start investing in canada - what is mer in investing?</strong>
            <p>
