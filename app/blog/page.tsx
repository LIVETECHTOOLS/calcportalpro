...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      'Learn how to calculate how much house you can afford in 2025. Understand debt-to-income ratios, down payments, and use our mortgage calculator.',
  ...
  },
  {
    ...
    excerpt:
      'Discover the best CD rates in 2025. Learn about CD laddering strategies, when to invest in CDs, and use our CD calculator to maximize your returns.',
    category: 'Investing',
    author: 'CalcPortal Pro Team',
    readTime: '9 min',
  ...
  },
  {
    ...
    excerpt:
      'Stay updated with Canada FPT and GST payment dates for 2025. Learn about eligibility, payment amounts, and how to calculate your benefits.',
    category: 'Taxes',
    author: 'CalcPortal Pro Team',
    readTime: '8 min',
  ...
  },
  {
    ...
    excerpt:
      'From personal loans to mortgages, understanding the different types of loans available can help you make better borrowing decisions.',
    category: 'Loans',
  ...
  },
  {
    ...
    excerpt:
      'Start your investment journey with these proven strategies for building a diversified portfolio that aligns with your financial goals.',
    category: 'Investing',
    author: 'Emily Foster',
    readTime: '7 min',
  ...
  },
  {
    ...
    excerpt:
      'Understanding the difference between APR and interest rate can save you thousands on loans and credit cards.',
    category: 'Loans',
    author: 'Michael Chen',
    readTime: '10 min',
  ...
  },
  {
    ...
    excerpt:
      'Your GPA is one of the most important factors in college admissions. Learn how to calculate, improve, and present your academic performance.',
    category: 'Education',
  ...
  },
  {
    ...
    excerpt:
      'Discover proven study techniques and strategies that can help you boost your GPA and academic performance.',
    category: 'Education',
    author: 'Dr. Lisa Rodriguez',
    readTime: '6 min',
  ...
  },
  {
    ...
    excerpt:
      'Compare the costs and benefits of buying vs renting to make the best decision for your financial future.',
    category: 'Real Estate',
  ...
  },
  {
    ...
    excerpt:
      'Maximize your tax savings with these essential deductions that can reduce your business tax liability.',
    category: 'Taxes',
  ...
  },
  {
    ...
    excerpt:
      'A complete guide to 2025 U.S. federal tax brackets, standard deduction, and practical planning strategies.',
    category: 'Taxes',
    author: 'CalcPortal Pro Team',
    readTime: '11 min',
    publishDate: '2025-01-15',
  ...
  },
  {
    ...
    excerpt:
      'Daylight savings 2025 key dates, states opting out, and whether DST could become permanent.',
    category: 'Savings',
    author: 'CalcPortal Pro Team',
    readTime: '9 min',
    publishDate: '2025-01-15',
  ...
  },
  {
    ...
    excerpt:
      'Understand student loan types, protections, repayment plans, and late payment differences in 2025.',
    category: 'Loans',
    author: 'CalcPortal Pro Team',
    readTime: '13 min',
    publishDate: '2025-01-15',
  ...
  },
  {
    ...
    excerpt:
      'Learn how to budget your income using the 50/30/20 rule and practical tips to stay consistent and grow savings in 2025.',
    category: 'Savings',
    author: 'CalcPortal Pro Team',
    readTime: '7 min',
  ...
  },
  {
    ...
    excerpt:
      'Understand when refinancing makes sense, how to calculate break-even, and how current rates affect your monthly payment.',
    category: 'Real Estate',
    author: 'CalcPortal Pro Team',
    readTime: '9 min',
    publishDate: '2025-01-19',
  ...
  },
  {
    ...
    excerpt:
      'Compare index funds and ETFs on costs, taxes, liquidity, and strategy to choose the best vehicle for your goals.',
    category: 'Investing',
    author: 'CalcPortal Pro Team',
    readTime: '8 min',
    publishDate: '2025-01-19',
  ...
  },
  {
    ...
    excerpt:
      'Actionable ways to improve your credit score in 2025—from utilization and on-time payments to credit builder loans.',
    category: 'Loans',
    author: 'CalcPortal Pro Team',
    readTime: '6 min',
    publishDate: '2025-01-19',
