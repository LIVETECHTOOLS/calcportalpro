              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th scope="col" className="text-left py-2">Tax Rate</th>
                    <th scope="col" className="text-left py-2">Single</th>
                    <th scope="col" className="text-left py-2">Married Filing Jointly</th>
                    <th scope="col" className="text-left py-2">Married Filing Separately</th>
                    <th scope="col" className="text-left py-2">Head of Household</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b">
