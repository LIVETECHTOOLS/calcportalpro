...
export default function GreaterPersonalLoanExplainedPage() {
  return (
    <BlogPostTemplate
      ...
      description="Learn how to find a "
      keywords="finance, money, guide"
      publishDate="2025-10-19T22:06:01.996Z"
      readTime="8 min"
      category="Loans"
