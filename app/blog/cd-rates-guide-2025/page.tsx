            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-300">
                  <th className="text-left py-2 px-2 text-gray-700 font-medium">CD Term</th>
                  <th className="text-right py-2 px-2 text-gray-700 font-medium">Best Rate</th>
                  <th className="text-right py-2 px-2 text-gray-700 font-medium">Bank</th>
                  <th className="text-right py-2 px-2 text-gray-700 font-medium">Min Deposit</th>
                </tr>
              </thead>
              <tbody>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-300">
                  ...
                  <th className="text-right py-2 px-2 text-gray-700 font-medium">Matures</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-300">
                  <th className="text-left py-2 px-2 text-gray-700 font-medium">Investment Type</th>
                  <th className="text-right py-2 px-2 text-gray-700 font-medium">Current Rate</th>
                  <th className="text-left py-2 px-2 text-gray-700 font-medium">Risk Level</th>
                  <th className="text-left py-2 px-2 text-gray-700 font-medium">Liquidity</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200">
