...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Learn how to get a mortgage with unfiled taxes in 2025. Real borrower strategies, lender requirements, FAQ, and tax solutions to help you qualify faster.',
    type: 'article',
    publishedTime: '2025-10-19T21:08:55.700Z',
    authors: ['CalcPortal Pro Team'],
  },
}

export default function CanIGetAMortgageWithUnfiledTaxesPage() {
  return (
    <BlogPostTemplate
      title="Can I Get a Mortgage with Unfiled Taxes in 2025?"
      description="Learn how to get a mortgage with unfiled taxes in 2025. Real borrower strategies, lender requirements, FAQ, and tax solutions to help you qualify faster."
      keywords="finance, money, guide"
      publishDate="2025-10-19T21:08:55.700Z"
      readTime="9 min"
      category="Taxes"
