...
export const metadata: Metadata = {
  ...
  keywords: 'canada fpt, what does fpt mean, gst payment dates 2025, cra tax benefits, gst hst credit canada, tax calculator canada',
  openGraph: {
    title: 'Canada FPT Payments & GST Dates 2025',
    description: 'Find Canada FPT payment dates for 2025, learn what FPT means on CRA deposits, and calculate your GST/HST credits. Updated eligibility rules included.',
    type: 'article',
    publishedTime: '2025-10-19T22:06:01.517Z',
    authors: ['CalcPortal Pro Team'],
  },
}

export default function CanadaFptGstPaymentDates2025Page() {
  return (
    <BlogPostTemplate
      title="Canada FPT Payments & GST Dates 2025"
      description="Find Canada FPT payment dates for 2025, learn what FPT means on CRA deposits, and calculate your GST/HST credits. Updated eligibility rules included."
      keywords="canada fpt, what does fpt mean, gst payment dates 2025, cra tax benefits, gst hst credit canada, tax calculator canada"
      publishDate="2025-10-19T22:06:01.517Z"
      readTime="6 min"
      category="Taxes"
