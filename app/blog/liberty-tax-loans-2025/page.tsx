...
export const metadata: Metadata = {
  ...
  description: 'Liberty Tax & Loans 2025 — in-depth guide to Liberty Tax services, holiday loan program, maximum refund guarantee, booking appointments, and how to apply online. Honest take, pros/cons, and FAQs.',
  keywords: 'finance, money, guide',
  openGraph: {
    title: 'Liberty Tax & Loans 2025: Holiday Loan, Services, and How to Apply',
    description: 'Liberty Tax & Loans 2025 — in-depth guide to Liberty Tax services, holiday loan program, maximum refund guarantee, booking appointments, and how to apply online. Honest take, pros/cons, and FAQs.',
    type: 'article',
    publishedTime: '2025-10-19T22:06:02.879Z',
...
export default function LibertyTaxLoans2025Page() {
  return (
    <BlogPostTemplate
      ...
      description="Liberty Tax & Loans 2025 — in-depth guide to Liberty Tax services, holiday loan program, maximum refund guarantee, booking appointments, and how to apply online. Honest take, pros/cons, and FAQs."
      keywords="finance, money, guide"
      publishDate="2025-10-19T22:06:02.879Z"
      readTime="11 min"
      category="Taxes"
