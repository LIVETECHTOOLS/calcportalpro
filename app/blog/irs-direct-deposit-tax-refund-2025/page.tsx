...
export const metadata: Metadata = {
  ...
  keywords: 'irs direct deposit tax refund, tax refund direct deposit, IRS refund status, faster tax refund, direct deposit refund, IRS direct deposit 2025, tax refund timing, refund tracking',
  openGraph: {
...
export default function IRSDirectDepositPage() {
  return (
    <BlogPostTemplate
      title="IRS Direct Deposit Tax Refund 2025: Complete Guide to Faster Refunds"
      description="Learn about IRS direct deposit tax refund options for 2025. Get your tax refund faster with direct deposit, track your refund status, and avoid common delays."
      ...
      calculatorText="Calculate your tax refund amount with our tax calculator."
      adSlots={["6578932201", "6578932202", "6578932203"]}
      slug="irs-direct-deposit-tax-refund-2025"
    >
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-6 my-6">
        <h4 className="font-semibold text-blue-900 mb-2">Direct Deposit Advantages:</h4>
        <ul className="text-blue-800 space-y-1">
          <li>• Faster refund delivery (1-2 business days)</li>
          <li>• More secure than paper checks</li>
          <li>• No risk of lost or stolen mail</li>
          <li>• Immediate access to funds</li>
          <li>• Environmentally friendly</li>
          <li>• Can be split between multiple accounts</li>
        </ul>
      </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
        ...
        <ul className="text-gray-700 space-y-2">
          <li>• Direct deposit is the fastest way to receive your tax refund</li>
          <li>• Refunds typically appear in your account within 1-2 business days</li>
          <li>• Use the IRS "Where's My Refund" tool to track your refund status</li>
          <li>• Double-check your bank account and routing numbers</li>
          <li>• File early and e-file your return for faster processing</li>
          <li>• Contact your bank or the IRS if your refund doesn't arrive</li>
          <li>• Direct deposit is more secure than paper checks</li>
          <li>• You can split your refund between multiple accounts</li>
        </ul>
      </div>
    </BlogPostTemplate>
  )
