...
export default function TimeCalculator() {
  ...
  const calculateTimeDifference = (): TimeResults => {
  ...
  const calculateTimeAddition = (): TimeResults => {
    const start = parseTime(formData.startTime);
  ...
  const calculateWorkingHours = (): TimeResults => {
    const start = parseTime(formData.startTime);
    const end = parseTime(formData.endTime);
  ...
  const calculateTimeConversion = (): TimeResults => {
