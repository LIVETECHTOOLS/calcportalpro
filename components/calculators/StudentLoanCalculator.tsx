...
export default function StudentLoanCalculator() {
  ...
  const calculateStudentLoan = useCallback((data: typeof formData): StudentLoanResult => {
  ...
  const results = useMemo<StudentLoanResult>(() => calculateStudentLoan(formData), [formData, calculateStudentLoan]);
