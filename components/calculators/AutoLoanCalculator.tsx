...
export default function AutoLoanCalculator() {
  ...
  const calculateAutoLoan = useCallback((data: typeof formData): AutoLoanResult => {
  ...
  const results = useMemo<AutoLoanResult>(() => calculateAutoLoan(formData), [formData, calculateAutoLoan]);
